            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="pages-blank.html" aria-expanded="false"><i class="fa fa-bookmark-o"></i><span class="hide-menu">신고 내역 관리</span></a>
                        </li>
                            ...
                            <%
								...
								try{
									...
									while(rs.next()){
										...
										out.println("<h5>"+ rs.getString("rno") +"</h5> <span class='mail-desc'>"+ rs.getString("rme") +"</span> <span class='time'>"+ rs.getString("rdate") +"</span> </div>");
										out.println("</a>");
									}
